...
import { getAllReservationOfARestaurant, getOrderInfoUsingOrderId, getReservationOfARestaurantByDate } from "../utilities/pos.utility";
...
let posController = { getOrderInfo, getAllReservations, getReservationByDate }
